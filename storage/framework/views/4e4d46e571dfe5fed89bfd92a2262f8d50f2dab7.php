...
<form method="post" enctype="multipart/form-data" action="<?php echo e(url('/photo')); ?>">
	<?php echo csrf_field(); ?>
	<table>
		<tr>
			<th>Judul</th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webweban\resources\views/photo/add.blade.php ENDPATH**/ ?>